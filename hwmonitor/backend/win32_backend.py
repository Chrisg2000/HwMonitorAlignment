...
from hwmonitor.win32.flags import SystemMetricsFlags, QUERY_DEVICE_CONFIG_FLAGS, \
    DISPLAYCONFIG_DEVICE_INFO_TYPE, DISPLAY_DEVICE_FLAGS, DEVICE_MODE_MODE, DEVICE_MODE_FIELD_FLAGS, \
    CHANGE_DISPLAY_SETTINGS
from hwmonitor.win32.func import GetSystemMetrics, EnumDisplaySettings, EnumDisplayDevices, GetDisplayConfigBufferSizes, \
    QueryDisplayConfig, DisplayConfigGetDeviceInfo, ChangeDisplaySettingsEx
from hwmonitor.win32.structs.displayconfig import DISPLAYCONFIG_TARGET_DEVICE_NAME
